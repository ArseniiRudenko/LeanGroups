    ...
    <div class="dropdown ticketDropdown groupIdDropdown show">
        ...
        <ul class="dropdown-menu" aria-labelledby="groupDropdownMenuLink<?= $row['id']?>">
            ...
            <li class="dropdown-item">
                <a hx-swap='outerHTML' hx-target='#groupDropdownMenuLink<?= $row['id']?>' hx-post='/LeanGroups/pill?ticket_id=<?=$row['id']?>&group_id=0&group_name=No Group' >No Assignment Group</a>
            </li>
